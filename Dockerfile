...
RUN apt-get -y update &&\
	apt-get -y --no-install-recommends install chromium-chromedriver shellcheck php$PHP_MINOR-pcov php$PHP_MINOR-xsl php$PHP_MINOR-intl php$PHP_MINOR-mbstring php$PHP_MINOR-zip php$PHP_MINOR-sqlite &&\
